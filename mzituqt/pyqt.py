...
class Window(class_basic_class,class_ui):
    ...
    def __init__(self):
        ...
        self.pushButton_2.clicked.connect(lambda: self._nextPage(1))
        self.pushButton_3.clicked.connect(lambda: self._nextPage(-1))
